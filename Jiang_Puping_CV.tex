 ...
 %\itemsep -2pt % Reduce space between items
    \begin{enumerate}[resume,leftmargin=*]
        ...
        \item \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4815339}{\textbf{Data-Driven Asset Selling.}} (with {\it Lingxiu Dong}), \textit{Under Review}
            ...
            \end{itemize}
        \item \textbf{Online Optimization in Asset Selling Platforms.} (with {\it Ren\'{e} Caldentey} and {\it Lingxiu Dong}), \textit{In Preparation}.
        \item \textbf{How Does Delay Matter? Online Matching with Delayed Stochastic Rewards.} (with {\it Yiding Feng} and {\it Wei Tang}), \textit{In Preparation}.
    \end{enumerate}
